...
class Catalogo : AppCompatActivity() {
    var adapter: MoviewAdapter? = null
    var seriesAdapter: MoviewAdapter? = null
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Héroe Por Encargo",R.drawable.heroeencargo,R.drawable.heroexencargo,"Un ex agente de las fuerzas especiales acepta un trabajo para brindar seguridad a una periodista mientras entrevista a un dictador, pero estalla un golpe militar en medio de la entrevista y se ven obligados a escapar a la jungla donde deben sobrevivir.",arrayListOf<Cliente>()))
    ...
    fun cargarSeries(){
     ...
     class MoviewAdapter: BaseAdapter {
